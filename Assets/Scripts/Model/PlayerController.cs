...
public class PlayerController : MonoBehaviour
{
    ...
    void Start() {
        ...
        this.UpdateAsObservable()  // AddTo 不要
    ...
    private IEnumerator AutoBattle(ObstacleBase obstacle) {
        ...
        // 教材用の AttackPlayer メソッド
        void AttackPlayer() {

            // 攻撃力を設定
            int totalAttackPower = 1;
            ...
            // TODO フローティングメッセージの生成


            // 障害物の Hp が 0 以下になったら
            if (obstacle.HP <= 0) {

                // ステートを切り替えて while 文を終了する
